   ...
   <div class="col-xl-12 col-lg-6 col-md-12">
      <div class="card">
         <div class="card-header">
            <h4 class="card-title">Edit [{{$admin->admin_name}}]</h4>
         </div>
         <div class="card-block">
            <div class="card-body">
                 <div class="col-md-12">
                  {!! Form::model($admin,['route' => ['control.admins.update', $admin->id], 'method' => 'put','files' => true, 'class' => '']) !!}
                        @include('control.admins.inputs')
                  {!! Form::close() !!}
                 </div>
            </div>
         </div>
